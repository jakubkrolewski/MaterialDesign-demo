...
public class RecyclerViewActivity extends Activity implements RecyclerViewItemClickListener<ExampleAdapter.ViewHolder> {
    ...
    private static final String EXTRA_CUSTOM_LAYOUT_MANAGER = "customLayoutManager";
    ...
    public static Intent createIntent(Context context, boolean customLayoutManager, boolean useCardLayout) {
        return new Intent(context, RecyclerViewActivity.class)
                .putExtra(EXTRA_CUSTOM_LAYOUT_MANAGER, customLayoutManager)
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		RecyclerView.LayoutManager layoutManager = getIntent().getBooleanExtra(EXTRA_CUSTOM_LAYOUT_MANAGER, false) ?
                new SpannableGridLayoutManager(this) :
